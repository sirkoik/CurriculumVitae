...
\begin{description}
  ...
  \begin{itemize}
    \item Lean Six Sigma Yellow Belt Certification, Mar 2022.
  \end{itemize} 
\end{description}
...
\begin{description}
  ...
  \item [Quality Control] Six Sigma, Lean Six Sigma (\href{https://api.badgr.io/public/assertions/JhPP0s2rQWWGrc9ZkYqhkg}{White Belt} level of mastery)
