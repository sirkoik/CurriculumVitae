...
\noindent
I am a developer specializing in web and app front-ends. I have experience collaborating with teams, supervisors and peers, and providing extensive and detailed feedback in software prototype tests.
...
\begin{description}
  ...
  \item[\href{https://sirkoik.github.io/BorisovXmas}{Comet 2P/Borisov}] Narrated tale about comet 2P/Borisov. Uses CSS and JavaScript to create a scrolling story. \href{https://sirkoik.github.io/BorisovXmas}{Live site} | \href{https://github.com/sirkoik/BorisovXmas}{Source code}
  \item[\href{https://sirkoik.github.io/February}{Valentine's Day card}] Animated Valentine's Day greeting card app with customizable message. Uses JavaScript and ThreeJS. \href{https://sirkoik.github.io/February}{Live site} | \href{https://github.com/sirkoik/February}{Source code}
\end{description}
...
\begin{description}
  ...
  \item [\href{https://www.codewars.com/users/sirkoik}{Codewars}] level 5.
\end{description}
...
\begin{description}
  ...
  \item [\href{https://nextjs.org/conf}{NextJS Conf 2021}] Oct 2021. Learned about NextJS 12 and edge functions. Watched speakers from various companies such as Invision talk about how NextJS helped both their developer and user experience.
