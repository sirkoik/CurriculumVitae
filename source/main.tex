...
Learned about NodeJS event loop, event emitters, streams, Node Package Manager (npm), and testing (Mocha, Chai).
\sectionsep
...
Learned how to write dynamic websites using the React library. Also learned how to use libraries like Redux and NextJS.
\sectionsep
